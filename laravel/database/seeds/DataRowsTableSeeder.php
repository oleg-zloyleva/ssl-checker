...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $dataRow = $this->dataRow($siteDataType, 'url');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'text',
                'display_name' => 'Url',
        ...
        $dataRow = $this->dataRow($siteDataType, 'ssl_last_update');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'date',
                'display_name' => 'Ssl Last Upodate',
                'required' => 1,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
        ...
        $dataRow = $this->dataRow($siteDataType, 'ssl_expires_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'date',
                'display_name' => 'Ssl expires at',
                'required' => 1,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
        ...
        $dataRow = $this->dataRow($siteDataType, 'updates_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'timestamp',
